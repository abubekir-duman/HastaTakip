...
namespace Business.Services
{
    ...
    public class KlinikService : IKlinikService
    {
        ...
        {
            return _db.Klinikler.OrderBy(k => k.Adi).Select(k => new KlinikModel() //k:kliniklerdeki her bir klinik tipindeki eleman delegasyonu
            {
                //entity özellikleri
        ...
        public KlinikModel GetItem(int id) => Query().SingleOrDefault(g => g.Id == id);
        ...
        public Result Update(KlinikModel model)
        {
            ...
            _db.SaveChanges();
            return new SuccessResult("Klinik Başarı ile güncellendi!");
        }
        ...
        public Result Delete(int id)
        {
            ...
            return new SuccessResult("Klinik Başarı İle Silindi");
